...
public class GoTo extends AdminCommand
{
	...
	public void executeCommand(Player admin, String[] params)
	{
		...
		{			
			...
			PacketSendUtility.sendMessage(admin, "Teleported to Admastrong.");
		}
		...
		else if(params[0].toLowerCase().equals("dropnir"))
		{
			teleportService.teleportTo(admin, 320080000, 491, 368, 623, 0);
			PacketSendUtility.sendMessage(admin, "Teleported to Dropnir Cavern");
		}
		else 
