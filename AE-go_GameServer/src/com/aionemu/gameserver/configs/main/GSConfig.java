...
public class GSConfig
{
	...
	@Property(key = "gameserver.motd", defaultValue = "Accueil")
	public static String			SERVER_MOTD;
	
	@Property(key = "admin.tag1",defaultValue = "*VIP*")
	public static String			ADMIN_TAG1;
	
	@Property(key = "admin.tag2",defaultValue = "*Anim*")
	public static String			ADMIN_TAG2;
	
	@Property(key = "admin.tag3",defaultValue = "*GM*")
	public static String			ADMIN_TAG3;
	
	@Property(key = "admin.tag4",defaultValue = "*Dev*")
	public static String			ADMIN_TAG4;
	
	@Property(key = "admin.tag5",defaultValue = "*Admin*")
